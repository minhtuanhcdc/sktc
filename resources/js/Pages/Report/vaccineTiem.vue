    ...
    <AdminLayout :chuyenKhoan="chuyenKhoan" :tienMat="tienMat"  :total_pay="total_pay" :unpaid="unpaid">
      <Head title="Custommer"></Head>
        <div class="bg-blue-600 px-8 flex items-center justify-between h-8"> 
            <span class="text-white">Thống kê - Vacxin(Vật tư)</span>
        </div>
        <div class="flex border-2 border-blue-900 items-center  justify-between py-2 bg-gray-200">
            ...
            <div class="w-24 py-1">
                <a :href="route('vaccineReport',{'startDate':startDate,'endDate':endDate,'id_service':id_service,'buoi':buoi})" target="blank">
