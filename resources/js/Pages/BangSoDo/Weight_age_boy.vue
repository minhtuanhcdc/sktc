    ...
    <AdminLayout>
        ...
        <div class="mt-1 w-full object-fix justify-center">
          <div class="flex justify-between py-0 px-4">
            <div class="flex m-auto flex-col leading-4 justify-center bg-blue-800 py-1 mb-1">
                <span class="font-bold uppercase py-2 px-4 m-auto leading-3 text-white">Bảng đánh giá <span class="text-hcdc2 font-bold">cân nặng</span> theo <span class=" font-bold text-hcdc2">tuổi</span> bé trai</span>
            </div>
          ...
          <div class="border border-hcdc2" v-if="openModal">
           ...
           <div class="relative overflow-x-auto shadow-md sm:rounded-lg flex flex-col justify-center">
            <div  class="bg-blue-800 text-center text-white py-1" >WHO Child Growth Standards</div>
